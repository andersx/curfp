 ...
 *
 * Double-precision copy of curfp_ssfr2.cpp: float -> double,
 * cublasSsyr2 -> cublasDsyr2, cublasSger -> cublasDger.
 */
...
static void get_dsfr2_params(int nisodd, int normaltransr, int lower,
...
extern "C"
curfpStatus_t curfpDsfr2(curfpHandle_t    handle,
                          ...
                          double          *arf)
{
    ...
    dsfr2_params_t p;
    get_dsfr2_params(nisodd, normaltransr, lower, n, n1, n2, nk, &p);

    CURFP_CHECK_CUBLAS(cublasDsyr2(cb,
    ...
    if (p.dim2 > 0) {
        ...
        const double *y2 = y + (size_t)p.dim1 * incy;
